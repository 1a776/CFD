...
| 文件 | 修改内容 | 针对的问题 |
|---|---|---|
| `UDF/solver/01_advection_equation/explicitAdvectionFoamStudent/explicitAdvectionFoamStudent.C` | 改进时间循环结束判据 | 避免浮点误差导致额外的伪时间步 |
...
0/T 和最终时间/T
    ...
    -> 计算精确解和误差
    -> matplotlib 绘图
    -> figures/01_advection_equation/cases/01_sine_wave_quad/N20/*.png
```
...
```text
figures/01_advection_equation/cases/01_sine_wave_quad/N20/field_comparison.png
```
...
```text
figures/01_advection_equation/cases/01_sine_wave_quad/N20/diagonal_profile.png
```
...
```text
figures/01_advection_equation/cases/01_sine_wave_quad/N20/amplitude_history.png
```
...
```text
figures/01_advection_equation/cases/01_sine_wave_quad/N20/cfl_history.png
```
...
figures/01_advection_equation/analysis/01_sine_wave_quad/convergence_errors.png
figures/01_advection_equation/analysis/01_sine_wave_quad/convergence_order.png
figures/01_advection_equation/analysis/01_sine_wave_quad/all_N_comparison.png
```
...
下面的数值是历史教学示例，不代表当前目录中仍然保留这些多网格结果。当前多网格结果已按用户要求清理；重新运行四个 N 后，应以新生成的 `data/01_advection_equation/analysis/01_sine_wave_quad/convergence_summary.csv` 为准。
...
data/01_advection_equation/cases/01_sine_wave_quad/N20/time_history.csv
figures/01_advection_equation/cases/01_sine_wave_quad/N20/field_comparison.png
figures/01_advection_equation/cases/01_sine_wave_quad/N20/diagonal_profile.png
figures/01_advection_equation/cases/01_sine_wave_quad/N20/amplitude_history.png
figures/01_advection_equation/cases/01_sine_wave_quad/N20/cfl_history.png
