...
```text
/home/a776/workdocuments/上交船舶/slover/student_project/cases/01_advection_equation/01_sine_wave_quad
```
...
```text
cases/01_advection_equation/01_sine_wave_quad/N20/log.checkMesh
```
