...
flowchart TD
    ...
    O --> P[figures/cases/04_solid_rotation_quad_upwind/N100/contour_final.png]
    O --> Q[data/cases/04_solid_rotation_quad_upwind/N100/summary.json]
```
...
```text
figures/cases/04_solid_rotation_quad_upwind/N100/contour_final.png
figures/cases/04_solid_rotation_quad_upwind/N100/field_comparison.png
figures/cases/04_solid_rotation_quad_upwind/N100/cfl_history.png
data/cases/04_solid_rotation_quad_upwind/N100/summary.json
data/cases/04_solid_rotation_quad_upwind/N100/field_data.csv
```
...
| 检查项 | 合格标准 |
|---|---|
| case 准备 | `cases/04_solid_rotation_quad_upwind/N100/` 生成成功 |
