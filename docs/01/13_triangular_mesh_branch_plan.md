...
| `cases/01_sine_wave_quad/Nxx/system/blockMeshDict` | 网格来源就是 `blockMesh` |
...
```text
cases/01_sine_wave_quad/              # 保留，作为四边形参考
cases/02_sine_wave_quad_linearUpwind/ # 保留，作为另一种格式参考
cases/03_sine_wave_tri_upwind/        # 新增，作为三角形分支
```
...
```text
cases/03_sine_wave_tri_upwind/N20/system/mesh.geo
```

或者：

```text
cases/03_sine_wave_tri_upwind/N20/system/tri_mesh.geo
```
...
### 3.6 `scripts/configs/03_sine_wave_tri_upwind.json`
...
```text
cases/03_sine_wave_tri_upwind/
```

并且继续按分辨率分子目录：

```text
cases/03_sine_wave_tri_upwind/N10/
cases/03_sine_wave_tri_upwind/N20/
cases/03_sine_wave_tri_upwind/N40/
cases/03_sine_wave_tri_upwind/N80/
```
...
```text
data/cases/03_sine_wave_tri_upwind/N20/mesh_geometry.json
```
...
1. 先建 `cases/03_sine_wave_tri_upwind/N20/`；
...
1. `cases/03_sine_wave_tri_upwind/N20/` 能独立生成；
...
- `cases/03_sine_wave_tri_upwind/Nxx/`
